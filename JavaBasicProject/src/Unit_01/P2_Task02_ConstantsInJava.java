...
public class P2_Task02_ConstantsInJava {
    ...
    final int i=1;
    public static final float a = 2.34f; //Visibility: Within Same Class and Any Package
    private static final int b = 4;//Visibility: Within Same Class
    protected final int c = 1;// Visibility: Within the Same Class and Same Package
